...
import { Text, View, TouchableOpacity, ScrollView, Image, Modal, Pressable, Dimensions } from "react-native";
...
export default function regulation() {
  ...
  return (
    <View className="flex-1">
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 140, paddingHorizontal: 15 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="border-2 border-black rounded-lg p-2">
          ...
          <View className="mb-1 p-2 rounded-lg">
            ...
            <View className="flex-col bg-gray-900/5 p-2 rounded-lg border border-gray-300">
              ...
              <Text style={{ fontFamily: "LexRegular" }} className="text-sm text-[#72C02C]">
                Perka No. 12 Tahun 2019 Persyaratan dan Tata Cara Pengenaan Tarif Nol Rupiah Atas Jenis PNBP
              </Text>
            </View>
          </View>
          <View className="mb-1 p-2 rounded-lg">
            <Text style={{ fontFamily: "LexRegular" }} className="text-md mb-2">
              Produk dan Tarif sesuai PP No. 47 Tahun 2018 Tentang Jenis dan Tarif penerimaan Negara Bukan Pajak yang Berlaku di BMKG.
            </Text>
            <View className="flex-col bg-gray-900/5 p-2 rounded-lg border border-gray-300">
              <Text style={{ fontFamily: "LexRegular" }} className="text-sm">
                Sesuai dengan:
          ...
          <View className="mb-1 p-2 rounded-lg">
            <Text style={{ fontFamily: "LexRegular" }} className="text-md mb-2">
              Peraturan PTSP sesuai Perka No. 01 Tahun 2019 Tentang Pelayanan Terpadu Satu Pintu di BMKG.
            </Text>
            <View className="flex-col bg-gray-900/5 p-2 rounded-lg border border-gray-300">
              <Text style={{ fontFamily: "LexRegular" }} className="text-sm">
                Sesuai dengan:
          ...
          <View className="mb-1 p-2 rounded-lg">
            <Text style={{ fontFamily: "LexRegular" }} className="text-md mb-2">
              Manual PTSP BMKG untuk Pelanggan Untuk Alur Layanan Informasi dan Jasa Konsultasi MKG, Jasa Sewa Alat MKG dan Jasa Kalibrasi Alat MKG.
            </Text>
        ...
        <View className="my-8 flex-row justify-between">
          <TouchableOpacity activeOpacity={0.7} onPress={() => openModal([require("@/assets/images/Regulation/AlurLayanan.jpg")])}>
            <View className="items-center w-48 border-2 border-[#1275BA] rounded-md p-2">
              <Image source={require("@/assets/images/Regulation/AlurLayanan.jpg")} className="w-full h-40 object-cover rounded-lg border border-gray-300" />
          ...
          <TouchableOpacity activeOpacity={0.7} onPress={() => openModal([require("@/assets/images/Regulation/StandarLayanan1.jpg"), require("@/assets/images/Regulation/StandarLayanan2.jpg")])}>
            <View className="items-center border-2 border-[#1275BA] rounded-md p-2">
              <Image source={require("@/assets/images/Regulation/StandarLayanan1.jpg")} className="w-full h-40 object-cover rounded-lg border border-gray-300" />
              <Text style={{ fontFamily: "LexBold" }} className="text-xl mt-2">
                Standar Layanan
              </Text>
            </View>
          ...
          <Modal visible={modalVisible} transparent={false} animationType="fade">
            ...
            >
              {selectedImages.map((img, index) => (
                <ZoomAny key={index} cropWidth={width} cropHeight={height} imageWidth={width} imageHeight={height} style={{ backgroundColor: "black" }}>
                  <Image
                    source={img}
                    style={{
                      width,
        ...
        <View className="px-2">
          ...
          <View className="px-5 gap-4 mt-2">
            <TouchableOpacity
              ...
              activeOpacity={0.7}
            >
              <Text style={{ fontFamily: "LexBold" }} className="text-md text-white">
                Informasi Umum
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
            ...
            <View className="flex-row gap-1">
              <Text style={{ fontFamily: "LexRegular" }} className="text-xs text-black">
                catatan:
              </Text>
              <Text style={{ fontFamily: "LexRegular" }} className="text-xs text-black">
