  ...
  return (
    <View className="flex-1 items-center justify-center overflow-hidden">
      ...
      <View className="relative items-center bg-white rounded-lg px-6 py-8">
        ...
        <Text className="text-2xl text-center mb-4" style={{ fontFamily: "LexBold" }}>
        ...
        {step === 1 && (
          <View className="gap-6 mt-3">
            <View className="gap-1">
              ...
              <TextInput keyboardType="phone-pad" className="border border-[#6BBC3F] rounded-xl w-80 p-2" style={{ fontFamily: "LexRegular" }} />
            </View>
            <View className="gap-1">
              <Text className="text-md ml-1" style={{ fontFamily: "LexBold" }}>
                Nama Lengkap
              </Text>
              <TextInput className="border border-[#6BBC3F] rounded-xl w-80 p-2" style={{ fontFamily: "LexRegular" }} />
            </View>
            <View className="gap-1 w-80 relative">
              ...
              {isDropdownOpen && (
                <View className="absolute top-[75px] z-10 w-full bg-white border border-[#6BBC3F] rounded-xl shadow-md">
                  {options.map((item) => (
                    <Pressable key={item} onPress={() => handleSelect(item)} className="px-4 py-3">
        ...
        {step === 3 && (
          <View className="gap-6 pb-2 mt-2">
            ...
            <View className="gap-1">
              ...
              <TextInput multiline={true} numberOfLines={4} textAlignVertical="top" className="border border-[#6BBC3F] rounded-xl w-80 p-2" style={{ fontFamily: "LexRegular" }} />
            </View>
            <View className="gap-1">
              <Text className="text-md ml-1" style={{ fontFamily: "LexBold" }}>
                Provinsi
